...
public class BasicCourse extends OrderItem {
    public BasicCourse(String name, double price, CuisineEnum cuisine) {
        setType(OrderItemEnum.MAIN_COURSE);
        setName(name);
        setPrice(price);
        setCuisine(cuisine);
    }
    ...
    public boolean equals(Object obj) {
        ...
        BasicCourse object = (BasicCourse) obj;
